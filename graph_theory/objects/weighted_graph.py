...
"""
from graph_theory.objects import weighted_digraph, graph


class WeightedGraph(weighted_digraph.WeightedDigraph, graph.Graph):
    """
    Main properties:
    ...
    """
    def __init__(self, vertices, edges, adjacency_matrix):
        """
        Constructor
